...
class Pieteikums extends Model
{
    ...
    protected $fillable = ["Computers", "start_time", "end_time", "created_at", "updated_at", "first_name", "last_name", "phone", "email", "status", "user_id"];
    ...
    {
        return $this->hasOne(Rezervacija::class, 'pieteikuma_id', 'pieteikuma_id');
    }
}
