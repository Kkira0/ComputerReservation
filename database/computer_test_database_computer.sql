...
CREATE TABLE `computer` (
  ...
  `Rinda` int DEFAULT NULL,
  `Colona` int DEFAULT NULL,
...
INSERT INTO `computer` VALUES (1,'1234','Windows',3,7),(2,'2345','Linux',12321,8),(3,'3456','Ubuntu',435,2),(4,'5678','TempleOS',234,9);
