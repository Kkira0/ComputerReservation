...
LOCK TABLES `pc_parts` WRITE;
/*!40000 ALTER TABLE `pc_parts` DISABLE KEYS */;
INSERT INTO `pc_parts` VALUES (1,'GPU','Quadro RTX 4000','40GB ar VRAM'),(2,'GPU','RX 7600','Si ir mana videokarte'),(3,'CPU','Intel I9-10980XE','3.00Ghz, 36Threads, 18Cores');
/*!40000 ALTER TABLE `pc_parts` ENABLE KEYS */;
UNLOCK TABLES;
